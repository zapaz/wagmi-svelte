...
export type CreateVerifyMessageReturnType<selectData = VerifyMessageData> =
  RuneReturnType<QueryObserverResult<selectData, VerifyMessageErrorType>>;
...
>(
  ...
  const enabled = $derived(
    Boolean(address && message && signature && (query.enabled ?? true)),
  );
