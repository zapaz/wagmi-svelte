...
export type CreateTransactionReceiptReturnType<
  ...
  selectData = GetTransactionReceiptData<config, chainId>,
> = RuneReturnType<
  QueryObserverResult<selectData, GetTransactionReceiptErrorType>
>;
...
export function createTransactionReceipt<
  ...
  selectData = GetTransactionReceiptData<config, chainId>,
>(
  parameters: CreateTransactionReceiptParameters<
    config,
    chainId,
    selectData
  > = {},
  ...
  return storeToRune(store) as CreateTransactionReceiptReturnType<
    config,
    chainId,
    selectData
  >;
